import { call, ForkEffect, put, takeEvery, spawn, takeLatest, select } from "redux-saga/effects"
import { getCommentsSuccess, addCommentSuccess,addCommentFailure, addCommentUnathorized } from '../../slices/CommentSlice/commentSlice'
...
function* workerAddComment(action: any): GenFuncType {
    const { payload: { CommentObject, UserAuthToken, url, method } }: AddComment = action
